...
Route::group(['middleware' => ['auth','admin_access']], function () {
	...
	Route::resource('userteam','App\Http\Controllers\Admin\UserteamController');
	Route::delete('delete-user-team/{id}', 'App\Http\Controllers\Admin\UserteamController@destroy')->name('lead_user_team_delete');
	...
	Route::delete('delete/{id}', 'App\Http\Controllers\Admin\leadController@destroy')->name('lead_category_delete');
	...
	Route::delete('delete-person/{id}', 'App\Http\Controllers\Admin\leadController@lead_person_destroy')->name('lead_person_delete');
	...
	Route::delete('delete-source/{id}', 'App\Http\Controllers\Admin\leadController@lead_source_destroy')->name('lead_source_delete');
	...
	Route::delete('delete-status/{id}', 'App\Http\Controllers\Admin\leadController@lead_status_destroy')->name('lead_status_delete');
